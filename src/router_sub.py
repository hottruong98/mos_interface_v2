...
if __name__ == "__main__":
    ...
    speed_suggest_thread = threading.Thread(target=consume_from_queue, args=('speed-suggest-C1-V1', callback_speed_suggest))
    traffic_state_thread = threading.Thread(target=consume_from_queue, args=('M_traffic_total', callback_traffic_state))
